...
类 Claude Code 的 **coding agent harness**。规格来自 [learn-claude-code](https://github.com/shareAI-lab/learn-claude-code)（s01–s17），源码重写，不拼接课程章节。

模型负责推理和选工具。本仓库负责：一个循环、工具、权限、以及以后挂上的压缩、记忆、MCP、Workflow、Goal。

## 新工作区怎么开

1. 用 Cursor 打开本目录（不要打开课程仓库）。
